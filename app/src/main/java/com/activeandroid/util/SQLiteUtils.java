...
public final class SQLiteUtils {
	...
	public static final boolean FOREIGN_KEYS_SUPPORTED = false;//Build.VERSION.SDK_INT >= Build.VERSION_CODES.FROYO;
	...
	public static <T extends Model> List<T> processCursor(Class<? extends Model> type, Cursor cursor) {
		...
		try {
			...
			if (cursor.moveToFirst()) {
				do {
					Model entity = Cache.getEntity(type, cursor.getString(cursor.getColumnIndex("id")));
					if (entity == null) {
