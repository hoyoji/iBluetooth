...
public class MoneyTransactionProjectSummaryLoader extends
	...
	public MoneyTransactionProjectSummaryLoader(Context context, Bundle queryParams) {
		super(context);
	...
	private String buildSearchQuery(String type) {
		...
		if (mFriendUserId != null) {
			queryStringBuilder.append(" AND (main.ownerUserId = '"
					+ mFriendUserId + "' OR main.friendUserId = '" + mFriendUserId
