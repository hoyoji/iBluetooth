...
public class HomeCalendarGridChildListLoader extends AsyncTaskLoader<List<HyjModel>> {
...
//	    private ChangeObserver mChangeObserver;
	    ...
	    public HomeCalendarGridChildListLoader(Context context, Bundle queryParams) {
	    	super(context);
