...
@Table(name = "MoneyDepositIncomeApportion", id = BaseColumns._ID)
public class MoneyDepositIncomeApportion extends HyjModel implements MoneyApportion{
	...
	public MoneyDepositIncomeApportion(){
		super();
	...
	public String getMoneyDepositIncomeContainerId() {
		return mMoneyDepositIncomeContainerId;
	}

	public void setMoneyDepositIncomeContainerId(String mMoneyDepositIncomeContainerId) {
...
//	}
		...
		if(this.getMoneyDepositIncomeContainer() == null){
			...
			if(this.getFriendUserId() != null){
				...
				return new Select().from(ProjectShareAuthorization.class).where("projectId=? AND localFriendId=? AND state <> 'Delete'", 
				   this.getMoneyDepositIncomeContainer().getProjectId(), this.getLocalFriendId()).executeSingle();
			}
		}
	}
	...
	public void setMoneyId(String moneyTransactionId) {
		this.setMoneyDepositIncomeContainerId(moneyTransactionId);
	}	
